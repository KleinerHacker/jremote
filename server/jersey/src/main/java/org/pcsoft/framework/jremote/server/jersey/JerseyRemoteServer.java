...
import org.pcsoft.framework.jremote.api.RemoteServer;
...
final class JerseyRemoteServer implements RemoteServer {
    private final HttpServer httpServer;
    private final ClientProxyCache clientProxyCache = new ClientProxyCache(JerseyClientProxyFactory.getInstance());

    @SafeVarargs
    JerseyRemoteServer(URI uri, Class<? extends RemoteRestService>... serverImplClasses) {
